...
- las contraseñas se almacenan con `PasswordHasher<Usuario>`
- el login manual usa cookie auth
- el login con Google autentica contra Google y luego crea la cookie local de la app
- `Cliente` y `Profesional` se modelan como extensiones de `Usuario`
- el sistema usa una tabla de logins externos para vincular cuentas Google

## Recomendaciones para desarrollo

- usar `plantilla_appsettings.json` como referencia
- no commitear credenciales reales
- mantener migraciones sincronizadas con los cambios del modelo
- probar desktop y mobile porque varias vistas tienen comportamiento responsive distinto

## Posibles mejoras futuras

- mover secretos a User Secrets o variables de entorno
- agregar tests automáticos
- separar configuración de seed en una clase dedicada
- agregar confirmación de correo y cambio de contraseña con token

## Autor / contexto

Proyecto académico orientado a practicar:

- MVC
- Entity Framework
- autenticación y autorización
- integraciones externas como Google y SMTP
